...
def newNote(addy, data):
    ...
    if os.path.exists(filename) == False:
        ...
        <rich_text></rich_text><rich_text weight="heavy">Description</rich_text><rich_text>:\n\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Discovery of Vulnerability</rich_text><rich_text>\n\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Exploit Code Used</rich_text><rich_text>\n\n\n\n</rich_text> \
        ...
        <rich_text underline="single" weight="heavy">Operating System</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Architecture</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Domain</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Installed Updates</rich_text><rich_text>\n\n\n</rich_text></node> \
        ...
        <rich_text underline="single" weight="heavy">Writeable Files\Directories</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Directory List</rich_text><rich_text>\n\n\n\n</rich_text></node> \
        ...
        <rich_text underline="single" weight="heavy">Users</rich_text><rich_text>\n\n\n</rich_text> \
        ...
        <rich_text underline="single" weight="heavy">IPConfig\IFConfig</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Network Processes</rich_text><rich_text>\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">ARP</rich_text><rich_text>\n\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">DNS</rich_text><rich_text>\n\n\n\n</rich_text> \
        ...
        <rich_text weight="heavy">Service Exploited:\n\n\nVulnerability Type:\n\n\nExploit POC:</rich_text> \
        <rich_text>\n\n</rich_text><rich_text weight="heavy">Description</rich_text><rich_text>:\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Discovery of Vulnerability</rich_text><rich_text>\n\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Exploit Code Used</rich_text><rich_text>\n\n\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Proof\Local.txt File</rich_text><rich_text>\n \
        ☐ Screenshot with ifconfig\ipconfig\n☐ Submit too OSCP Exam Panel\n</rich_text></node> \
        ...
        <rich_text underline="single" weight="heavy">Software Versions</rich_text><rich_text>\n\n\n\n</rich_text> \
        ...
        <rich_text link="node 47">smbtree</rich_text><rich_text>\n</rich_text> \
        ...
        ☐  nmap -sU ipaddress\n\n</rich_text> \
        <rich_text underline="single" weight="heavy">Service Scanning</rich_text><rich_text>\n\n</rich_text> \
        <rich_text weight="heavy">WebApp</rich_text><rich_text>☐   </rich_text> \
        <rich_text link="node 28">Nikto</rich_text><rich_text>☐   </rich_text> \
        <rich_text link="node 32">dirb</rich_text><rich_text>☐   dirbuster\n☐   </rich_text> \
        <rich_text link="node 30">wpscan</rich_text><rich_text>☐   dotdotpwn\n☐   view source\n☐   davtest\cadevar \
        ☐   droopscan\n☐   joomscan\n☐   LFI\RFI Test\n</rich_text> \
        <rich_text weight="heavy">Linux\Windows</rich_text><rich_text>☐   snmpwalk -c public -v1 </rich_text> \
        <rich_text style="italic">ipaddress</rich_text><rich_text> 1\n☐   smbclient -L //ipaddress\n \
        ...
        <rich_text underline="single" weight="heavy">Post Exploitation</rich_text><rich_text>\n</rich_text> \
        <rich_text weight="heavy">Linux</rich_text>\n<rich_text>☐   linux-local-enum.sh\n \
        ☐   linuxprivchecker.py\n☐   linux-exploit-suggestor.sh\n☐   unix-privesc-check.py\n</rich_text> \
        <rich_text weight="heavy">Windows</rich_text><rich_text>☐   wpc.exe\n☐   windows-exploit-suggestor.py\n \
        ☐   </rich_text><rich_text link="webs \
        https://github.com/pentestmonkey/windows-privesc-check/blob/master/windows_privesc_check.py"> \
        windows_privesc_check.py</rich_text><rich_text>☐  	windows-privesc-check2.exe\n</rich_text> \
        ...
        </rich_text><rich_text weight="heavy">Windows</rich_text><rich_text>☐  List of exploits\n</rich_text> \
        <rich_text weight="heavy">Linux</rich_text><rich_text>☐  sudo su\n☐  KernelDB\n☐  Searchsploit\n</rich_text> \
